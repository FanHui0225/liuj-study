...
import com.stereo.study.rpc.utils.IdentityIntMap;
 ...
 * @author stereo
 */
public class Output extends AbstractOutput implements Constants {
	...
	public void writeVersion() throws IOException {
		// flushIfFull();
		// _buffer[_offset++] = (byte) 'H'; _buffer[_offset++] = (byte) 2;
	...
	public void writeObject(Object object) throws IOException {
		...
		Serializer serializer = findSerializerFactory().getObjectSerializer(
				object.getClass());
