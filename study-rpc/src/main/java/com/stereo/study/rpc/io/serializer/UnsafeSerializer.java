...
import com.stereo.study.rpc.io.Unshared;
...
public class UnsafeSerializer extends AbstractSerializer {
	...
	private static final Logger log = Logger.getLogger(UnsafeSerializer.class
			.getName());
	...
	public static UnsafeSerializer create(Class<?> cl) {
		...
		synchronized (_serializerMap) {
			...
			if (base == null) {
				if (cl.isAnnotationPresent(Unshared.class))
	...
	final public void writeInstance(Object obj, AbstractOutput out)
			throws IOException {
		try {
	...
	abstract static class FieldSerializer {
		abstract void serialize(AbstractOutput out, Object obj)
				throws IOException;
	}
	...
	final static class ObjectFieldSerializer extends FieldSerializer {
		...
		@Override
		final void serialize(AbstractOutput out, Object obj) throws IOException {
			try {
	...
	final static class BooleanFieldSerializer extends FieldSerializer {
		...
		void serialize(AbstractOutput out, Object obj) throws IOException {
	...
	final static class DateFieldSerializer extends FieldSerializer {
		...
		@Override
		void serialize(AbstractOutput out, Object obj) throws IOException {
			java.util.Date value = (java.util.Date) _unsafe.getObject(obj,
					_offset);
