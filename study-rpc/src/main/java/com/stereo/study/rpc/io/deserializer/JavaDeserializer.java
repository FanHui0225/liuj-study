...
public class JavaDeserializer extends AbstractMapDeserializer {
	...
	public Object readMap(AbstractInput in, Object obj)
			throws IOException {
		try {
	...
	private Object readObject(AbstractInput in, Object obj,
	...
	protected Object instantiate() throws Exception {
		try {
			...
			throw new ProtocolException("'" + _type.getName()
	...
	static class NullFieldDeserializer extends FieldDeserializer {
		...
		@Override
		void deserialize(AbstractInput in, Object obj)
				throws IOException {
			in.readObject();
		}
	}
	...
	static void logDeserializeError(Field field, Object obj, Object value,
		...
		if (e instanceof FieldException)
			...
			throw new FieldException(fieldName + ": " + e.getMessage(),
					e);
