...
import com.stereo.study.rpc.io.handle.ByteHandle;
import com.stereo.study.rpc.io.handle.FloatHandle;
import com.stereo.study.rpc.io.handle.ShortHandle;
 ...
 */
public class BasicSerializer extends AbstractSerializer implements
        ObjectSerializer {
	...
	private static final BasicSerializer BYTE_HANDLE_SERIALIZER = new BasicSerializer(
			BYTE_HANDLE);

	private static final BasicSerializer SHORT_HANDLE_SERIALIZER = new BasicSerializer(
			SHORT_HANDLE);

	private static final BasicSerializer FLOAT_HANDLE_SERIALIZER = new BasicSerializer(
			FLOAT_HANDLE);
	...
	public void writeObject(Object obj, AbstractOutput out)
		...
		default:
			throw new RuntimeException(_code + " unknown code for "
					+ obj.getClass());
		}
	}
}
