 ...
 */
package com.stereo.study.bytecode.utils;
...
public final class ReflectUtils {
    ...
    public static Class<?> name2class(String name) throws ClassNotFoundException {
        return name2class(com.alibaba.dubbo.common.utils.ClassHelper.getClassLoader(), name);
    }
    ...
    private static Class<?> name2class(ClassLoader cl, String name) throws ClassNotFoundException {
        ...
        if (cl == null)
            cl = com.alibaba.dubbo.common.utils.ClassHelper.getClassLoader();
    ...
    public static Class<?> desc2class(String desc) throws ClassNotFoundException {
        return desc2class(com.alibaba.dubbo.common.utils.ClassHelper.getClassLoader(), desc);
    }
