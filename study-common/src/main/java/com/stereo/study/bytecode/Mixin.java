...
import com.stereo.study.bytecode.utils.ClassHelper;
...
public abstract class Mixin {
    ...
    public static Mixin mixin(Class<?>[] ics, Class<?>[] dcs, ClassLoader cl) {
        ...
        String pkg = null;
        com.alibaba.dubbo.common.bytecode.ClassGenerator ccp = null, ccm = null;
        try {
            ccp = com.alibaba.dubbo.common.bytecode.ClassGenerator.newInstance(cl);
