package com.stereo.study.async.wrapper;

import com.stereo.study.async.callback.DefaultCallback;
import com.stereo.study.async.callback.ICallback;
import com.stereo.study.async.callback.IWorker;
import com.stereo.study.async.exception.SkippedException;
import com.stereo.study.async.executor.timer.SystemClock;
import com.stereo.study.async.worker.DependWrapper;
import com.stereo.study.async.worker.ResultState;
