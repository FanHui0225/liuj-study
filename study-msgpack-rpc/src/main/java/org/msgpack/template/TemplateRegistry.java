...
public class TemplateRegistry {
    ...
    protected void registerTemplatesWhichRefersRegistry() {
        ...
        register(ArrayList.class,arrayListTemplate);
        HashMapTemplate hashMapTemplate = new HashMapTemplate(this);
        register(HashMap.class,hashMapTemplate);
        HashSetTemplate hashSetTemplate = new HashSetTemplate(this);
        register(HashSet.class,hashSetTemplate);
